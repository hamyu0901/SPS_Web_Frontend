    ...
    methods: {
        ...
        realtimeData() {
            this.interval = setInterval(() => {
                ...
                var tempCmd = [];
                var tempFeedback = [];
                this.$http.post(`${this.baseUrl}/robotdetails/robotinfo/trend/turbin_speed`, {
                    factoryid: this.factoryid, boothid: this.boothid, zoneid: this.zoneid, robotid: this.robotid 
                        ...
                        for(var i = 0; i < result.data.length; i++) {
                           ...
                           var time = date.getUTCHours() + ':' + date.getUTCMinutes() + ':' + date.getUTCSeconds();
                            ...
                            tempCmd.push(result.data[i].turbin_speed_cmd);
                            tempFeedback.push(result.data[i].turbin_speed_feedback);
                        }
...
<style scoped lang="scss">
    @import './realtimegetturbinespeed';
</style>
