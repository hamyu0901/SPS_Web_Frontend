...
export default {
    ...
    methods: {
        initializeStyle() {
            ...
            this.options.scales.yAxes[0].ticks.color = '#4f5575';
            this.options.scales.yAxes[0].ticks.fontColor = '#ffffff';
            this.options.scales.xAxes[0].ticks.color = '#4f5575';
                ...
                this.$http.post(`${this.baseUrl}/robotdetails/robotinfo/trend/sa_s`, {
                    factoryid: this.factoryid, boothid: this.boothid, zoneid: this.zoneid, robotid: this.robotid 
                        ...
                        for(var i = 0; i < result.data.length; i++) {
                            ...
                            tempCmd.push(result.data[i].sa_s_cmd);
                            tempFeedback.push(result.data[i].sa_s_feedback);
                        }
