    ...
    <v-container fluid>
        <v-layout>
            <v-flex lg2>
                ...
                >
                    <v-layout>
                        <p class="pt-3 pl-3" v-bind:style="{ fontSize: card.text.fontSize, color: ui.hscMenuStyle.color }">BOOTH {{ui.booth}}</p>
                    </v-layout>
                </v-card>
            </v-flex>
            <v-flex lg2 class="pl-2">
                <hsc-menu-style-white class="menuZDirection">
                    <hsc-menu-bar class="elevation-0" v-bind:style="{ height: ui.size.height, width: ui.size.zoneWidth, backgroundColor: ui.hscMenuStyle.backgroundColor }">
                        <hsc-menu-bar-item class="pt-3" :label="ui.zone" v-bind:style="{ fontSize: ui.title.text.size, width: ui.size.zoneWidth, backgroundColor: ui.hscMenuStyle.backgroundColor, color:ui.hscMenuStyle.color }">
                            <hsc-menu-item 
                            ...
                            <div v-show="visible.robotL1Table">
                                <div class="L1">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.L[0])">
                                        <img :src="datas.L1.IMAGE"/>
                                        <figcaption>
                                            <p>{{datas.robot.L[0]}} Robot</p>
                                        </figcaption>
                                    </figure>
                                ...
                                <div v-if="visible.atomizer.L1 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotL2Table">
                                <div class="L2">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.L[1])">
                                            <img :src="datas.L2.IMAGE"/>
                                            <figcaption>
                                                <p>{{datas.robot.L[1]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.L2 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotL3Table">
                                <div class="L3">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.L[2])">
                                        <img :src="datas.L3.IMAGE" />
                                        <figcaption>
                                            <p>{{datas.robot.L[2]}} Robot</p>
                                        </figcaption>
                                    </figure>
                                ...
                                <div v-if="visible.atomizer.L3 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotL4Table">
                                <div class="L4">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.L[3])">
                                            <img :src="datas.L4.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.L[3]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.L4 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotL5Table">
                                <div class="L5">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.L[4])">
                                            <img :src="datas.L5.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.L[4]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.L5 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotR1Table">
                                <div class="R1">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.R[0])">
                                            <img :src="datas.R1.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.R[0]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.R1 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotR2Table">
                                <div class="R2">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.R[1])">
                                            <img :src="datas.R2.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.R[1]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.R2 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotR3Table">
                                <div class="R3">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.R[2])">
                                            <img :src="datas.R3.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.R[2]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.R3 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotR4Table">
                                <div class="R4">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.R[3])">
                                            <img :src="datas.R4.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.R[3]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.R4 == true && Boolean(getAuth)">
                            ...
                            <div v-show="visible.robotR5Table">
                                <div class="R5">
                                    <figure class="robotImageHover" v-on:click="moveRobotPage(datas.robot.R[4])">
                                            <img :src="datas.R5.IMAGE" />
                                            <figcaption>
                                                <p>{{datas.robot.R[4]}} Robot</p>
                                            </figcaption>
                                        </figure>
                                ...
                                <div v-if="visible.atomizer.R5 == true && Boolean(getAuth)">
                            ...
                            <table class="bodyTable">
                                <tr>
                                    <td :style=" { width : ui.body.table.td.width }">
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberUI}} </font>
                                    </td>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberData[0]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.modelNumberUI}}</font>
                                    </td>
                                    <td>
                                        <font :color="ui.bodyTextColor"> {{datas.body.modelNumberData[0]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorUI}} </font>
                                    </td>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorData[0]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionUI}} </font>
                                    </td>
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionData[0]}}</font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div v-show="getVisibleBody(2)" class="body2" v-bind:style="{ position: body.position, top: body.top, left: body.left, width: body.width, height: body.height }">
                            ...
                            <table class="bodyTable">
                                <tr>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberData[1]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.modelNumberData[1]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorData[1]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionData[1]}}</font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div v-show="getVisibleBody(3)" class="body3" v-bind:style="{ position: body.position, top: body.top, left: body.left, width: body.width, height: body.height }">
                            ...
                            <table class="bodyTable">
                                <tr>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberData[2]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.modelNumberData[2]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorData[2]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionData[2]}}</font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div v-show="getVisibleBody(4)" class="body4" v-bind:style="{ position: body.position, top: body.top, left: body.left, width: body.width, height: body.height }">
                            ...
                            <table class="bodyTable">
                                <tr>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberData[3]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.modelNumberData[3]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorData[3]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionData[3]}}</font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div v-show="getVisibleBody(5)" class="body5" v-bind:style="{ position: body.position, top: body.top, left: body.left, width: body.width, height: body.height }">
                            ...
                            <table class="bodyTable">
                                <tr>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.vinNumberData[4]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.modelNumberData[4]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.colorData[4]}}</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <font :color="ui.bodyTextColor">{{datas.body.optionData[4]}}</font>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <v-layout class="pt-2">
            <v-flex lg6>
                <robot-Alarms v-bind:contentData="infoAlarmTableContentData"></robot-Alarms>
            </v-flex>
            <v-flex lg2 class="pl-2">
                <v-card elevation="0" class="infoLayout">
                    <v-layout>
                        <v-flex xs4>
...
export default {
    ...
    methods: {
        initializeStyle() {
            this.ui.hscMenuStyle.backgroundColor = this.$style.monitoring.zoneMonitoringItemHscMenuStyleBackgroundColor;
            this.ui.hscMenuStyle.color = this.$style.monitoring.zoneMonitoringItemHscMenuStyleColor;
            this.ui.activeMode = this.$style.monitoring.zoneMonitoringItemActiveModeColor;
            this.ui.bodyTextColor = this.$style.monitoring.zoneMonitoringItemBodyStyleColor;
            this.loading.color = this.$style.monitoring.zoneMonitoringItemLoadingColor;
            this.conveyor.color = this.$style.monitoring.zoneMonitoringItemConveyorColor;
            document.documentElement.style.setProperty("--hscMenuStyleBackgroundColor", this.$style.monitoring.zoneMonitoringItemHscMenuStyleBackgroundColor);
            document.documentElement.style.setProperty("--hscMenuStyleColor", this.$style.monitoring.zoneMonitoringItemHscMenuStyleColor);
            document.documentElement.style.setProperty("--hscMenuStyleBorderColor", this.$style.common.cardItemBorderColor);
            document.documentElement.style.setProperty("--zoneLayoutBackgroundColor", this.$style.monitoring.zoneMonitoringItemBackgroundColor);
            document.documentElement.style.setProperty("--robotStyleBackgroundColor", this.$style.monitoring.zoneMonitoringItemRobotStyleBackgroundColor);
            document.documentElement.style.setProperty("--robotStyleColor", this.$style.monitoring.zoneMonitoringItemRobotStyleColor);
            document.documentElement.style.setProperty("--infoLayoutBackgroundColor", this.$style.monitoring.zoneMonitoringItemInfoStyleBackgroundColor);
            document.documentElement.style.setProperty("--infoLayoutColor", this.$style.monitoring.zoneMonitoringItemInfoStyleColor);
            document.documentElement.style.setProperty("--infoLayoutBorderColor", this.$style.common.cardItemBorderColor);
            document.documentElement.style.setProperty("--atomizerExternalColor", this.$style.monitoring.zoneMonitoringItemAtomizerStyleExternalColor);
        },
        destroyHandle() {
        ...
        insertPLCDatasForSealer(data) {
            switch (data.robot_name) {
                case 1:
                    this.datas.L1.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.L1.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.L1.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.L1.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.L1.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.L1.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 2:
                    this.datas.R1.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.R1.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.R1.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.R1.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.R1.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.R1.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 3:
                    this.datas.L2.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.L2.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.L2.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.L2.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.L2.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.L2.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 4:
                    this.datas.R2.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.R2.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.R2.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.R2.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.R2.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.R2.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 5:
                    this.datas.L3.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.L3.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.L3.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.L3.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.L3.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.L3.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 6:
                    this.datas.R3.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.R3.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.R3.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.R3.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.R3.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.R3.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 7:
                    this.datas.L4.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.L4.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.L4.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.L4.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.L4.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.L4.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 8:
                    this.datas.R4.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.R4.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.R4.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.R4.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.R4.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.R4.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 9:
                    this.datas.L5.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.L5.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.L5.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.L5.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.L5.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.L5.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
                    ...
                    break;
                case 10:
                    this.datas.R5.POSITION.home = (data.robot_mode_home == 1) ? this.ui.activeMode : '';
                    this.datas.R5.POSITION.run = (data.robot_mode_run == 1) ? this.ui.activeMode : '';
                    this.datas.R5.POSITION.bypass = (data.robot_mode_bypass == 1) ? this.ui.activeMode : '';
                    this.datas.R5.POSITION.auto = (data.robot_mode_auto == 1) ? this.ui.activeMode : '';
                    this.datas.R5.POSITION.teach = (data.robot_mode_teach == 1) ? this.ui.activeMode : '';
                    this.datas.R5.POSITION.rins = (data.robot_mode_rins == 1) ? this.ui.activeMode : '';
