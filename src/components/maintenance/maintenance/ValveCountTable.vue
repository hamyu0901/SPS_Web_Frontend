<template>
    <v-card class="valveCountTableCard text-xs-center" elevation="0" :color="cardColor" v-bind="initialize">
        <v-data-table
        ...
        >
            ...
            <template slot="items" slot-scope="props">
                <tr :ref="props.index" :key="props.index" @click="rowClicked(props.index, props.item)">
                    <td class="text-xs-center tdText">{{ props.item.valve_name }}</td>
                    ...
                    <td class="text-xs-center tdText">
                        <span>{{ props.item.valve_maint_count }}</span>
                    </td>
                    <td class="text-xs-center tdText">
                        <span>{{ props.item.current_valvecount }}</span>
                    </td>
                    <td class="text-xs-center tdText">
                        <v-btn 
                            class="buttonItem"
                            ...
                            v-if="props.item.details != undefined"
                        >
                            {{ detailTitle }}
                        </v-btn>
                    </td>
...
export default {
    ...
    methods: {
        initializeStyle() {
            ...
            document.documentElement.style.setProperty("--valveCountTableCardBorderColor", this.$style.common.cardItemBorderColor);
