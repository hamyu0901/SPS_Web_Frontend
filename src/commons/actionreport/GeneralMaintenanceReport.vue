...
export default {
    ...
    data() {
        return {
            ui: {
                contentsText: this.$t(`actionReport.GeneralMaintenanceReport.contentsText`),
                tagText: this.$t(`actionReport.GeneralMaintenanceReport.tagText`),
                titleText: this.$t(`actionReport.GeneralMaintenanceReport.titleText`),
                userIdText: this.$t(`actionReport.GeneralMaintenanceReport.userIdText`),
                typeText: this.$t(`actionReport.GeneralMaintenanceReport.typeText`),
                typeHintText: this.$t(`actionReport.GeneralMaintenanceReport.typeHintText`)
            },
            datas: {
                tags: ''
            }
    ...
    computed: {
        getAcceptReportFlag() {
            if(this.acceptReportFlag == true) {
                ...
                this.$emit('acceptGeneralMaintenanceReport', {
...
<style scoped lang="scss">
    @import "./generalmaintenancereport";
</style>
